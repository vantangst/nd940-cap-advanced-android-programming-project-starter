...
class RepresentativeViewHolder(val binding: RepresentativeItemBinding) :
    ...
    fun bind(item: Representative) {
        ...
        binding.ivRepresentative.setImageResource(R.drawable.ic_profile)
    ...
    companion object {
        fun from(parent: ViewGroup): RepresentativeViewHolder {
            ...
            return RepresentativeViewHolder(
                RepresentativeItemBinding.inflate(
                    inflater,
                    parent,
                    false
                )
    ...
    private fun showWWWLinks(urls: List<String>) {
        enableLink(binding.ivWww, urls.first())
    }
...
class RepresentativeDiffCallback : DiffUtil.ItemCallback<Representative>() {
    override fun areItemsTheSame(oldItem: Representative, newItem: Representative): Boolean {
        return oldItem.office.division.id == newItem.office.division.id &&
                oldItem.official.phones == newItem.official.phones
    }
